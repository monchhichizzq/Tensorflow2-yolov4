# -*- coding: utf-8 -*-
# @Time    : 2020/08/22 4:37
# @Author  : Zeqi@@
# @FileName: multi_gpu_train.py
# @Software: PyCharm
...
config = {'training': True,
          ...
          # Weights
          'load_weights': True,
          'weights_path' : 'logs/pretrained_models/ep089-loss10.883-val_loss12.048.h5',

          # checkpoints
          'save_best_only': True,
          'save_weights_only': True,
          'log_dir':'~/scratch-n/yolov4_logs/yolov4_voc_weights_416_fp16_adam/',
